...
const Uploader = (props) => {
  ...
  return (
    ...
    >
      <Row
        style={{ width: "100%", margin: 0, padding: "0px", height: "100vh" }}
      >
        <Col xs={2} style={{ padding: "0px" }}>
          <Sidebar page={"uploader"} navigateTo={props.navigateTo} />
        </Col>
        <Col xs={{ span: 8, offset: 1 }}>
          <Row>
            <div style={{ padding: "15px", marginTop: "10vh" }}>
              ...
              <p className="upload-description">
                {" "}
                Assess uses machine-learning to identify standards referenced in
                your work and standards relevant to your work. Upload a document
                or paste a block of text in the window below.
              </p>
            </div>
          </Row>
          <Row className="uploader-menu">
            <Col md={12} lg={6}>
              <button
                className={
                  mode == "pdf" ? "text-button-selected" : "text-button"
                }
            ...
            <Col md={12} lg={6}>
              <button
                className={
                  mode == "text" ? "text-button-selected" : "text-button"
                }
