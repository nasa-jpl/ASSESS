            ...
            <Row style={{ padding: "30px 0px" }}>
              <Col xs={12} sm={12} md={12} lg={10} style={{}}>
                <p className="report-description">
                  {" "}
                  Find referenced and recommended standards, by upload, in their
                  respective section below. If you do not find the stand you are
