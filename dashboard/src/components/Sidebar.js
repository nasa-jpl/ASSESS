...
const Sidebar = (props) => {
  ...
  return (
    <Container
      style={{ width: "100%", height: "100%", backgroundColor: "#343d4c" }}
    >
      <Row style={{ paddingTop: "10px", paddingLeft: "20px" }}>
        <Col>
          <button
            className={adminMode ? "sidebar-mode-selected" : "sidebar-mode"}
        ...
        <Col>
          <button
            className={adminMode ? "sidebar-mode" : "sidebar-mode-selected"}
      ...
      <Row>
        <Col>
          <h1 className="sidebar-title" style={{ paddingLeft: "10px" }}>
            {" "}
            ASSESS{" "}
          </h1>
        </Col>
      ...
      {adminMode ? (
        <div>
          <Row>
            <Col>
              <h3 className="sidebar-header" style={{ paddingLeft: "10px" }}>
                {" "}
                Admin Console{" "}
              </h3>
            </Col>
      ...
      {props.page == "uploader" ? (
        <Styled>
          <Row style={{ marginTop: "5vh" }}>
            <div className={props.page == "report" ? "rect-show" : "rect-hide"}>
              {" "}
            </div>
            <Button
          ...
          <Row>
            <div className={props.page == "search" ? "rect-show" : "rect-hide"}>
              {" "}
            </div>
            <Button
