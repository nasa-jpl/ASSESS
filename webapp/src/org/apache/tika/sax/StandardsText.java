...
public class StandardsText {
	...
	// reference
	private static final String REGEX_FALLBACK = "\\(?" + "(?<mainOrganization>[A-Z\\s]+\\w+)"
	...
	private static final String REGEX_STANDARD = ".*" + REGEX_ORGANIZATION + ".+" + REGEX_ORGANIZATION + "?.*"; //why is regex_organization locked to caps only 
